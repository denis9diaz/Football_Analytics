    ...
    def handle(self, *args, **kwargs):
        ...
        for partido in partidos_hoy:
            ...
            try:
                ...
                cuota_casa = fetch_cuota_casa(int(partido.codigo_api), "Goals Over/Under", "Over 1.5")
            ...
            self.stdout.write(self.style.SUCCESS(
                f"{partido} -> Over 1.5: {round(prob_media*100,2)}%, cuota: {cuota_real}, casa: {mostrar_cuota}, valor: {mostrar_valor}"
            ))
